			...
			if(NOT EXISTS "${_install_root}/bin/srsdu_low")
				if(NOT FALSE)
					message(FATAL_ERROR "Cannot find bin/srsdu_low")
				endif()
			else()
				file(SHA1 ${_install_root}/bin/srsdu_low _sha1)
...
"
FileName: ./bin/srsdu_low
SPDXID: SPDXRef-Binary-srsdu-low
FileType: BINARY
