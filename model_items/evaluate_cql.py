...
MODEL = "cql_scheduler.pth"
CSV = "DQN_CQL_scheduler_log.csv"
...
# Original ranking from behavior policy
replay["true_rank"] = (
...
with torch.no_grad():
    ...
    replay["pred_action"] = q.argmax(1).numpy()
    replay["pred_score"] = q.max(1).values.numpy()
